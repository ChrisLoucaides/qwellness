...
class GetStudentTasksTest(TestCase):
    ...
    def test_should_retrieve_tasks_associated_to_a_student(self):
        ...
        self.then_the_task_is_retrieved_and_we_get_a_response_code(response, 200)
    ...
    def test_should_not_retrieve_tasks_given_invalid_student(self):
        ...
        self.then_the_task_is_not_retrieved_and_we_get_a_response_code(response, 404)
        response_data = json.loads(response.content)
    ...
    def test_should_not_retrieve_student_tasks_given_wrong_http_method(self):
        ...
        self.then_the_task_is_not_retrieved_and_we_get_a_response_code(response, 405)
        response_data = json.loads(response.content)
    ...
    def then_the_task_is_retrieved_and_we_get_a_response_code(self, response, response_code):
    ...
    def then_the_task_is_not_retrieved_and_we_get_a_response_code(self, response, response_code):
        self.assertEqual(response.status_code, response_code)
